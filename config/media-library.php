...
return [
     ...
     */
    'queue_conversions_by_default' => env('QUEUE_CONVERSIONS_BY_DEFAULT', default: true),
    ...
    'image_generators' => [
        ...
        // Spatie\MediaLibrary\Conversions\ImageGenerators\Avif::class, // Disabled - requires PHP with AVIF support
