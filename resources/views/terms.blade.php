                    ...
                    <div class="lg:w-3/4">
                        <div class="max-w-4xl mx-auto">
                            ...
                            <section id="introduction" class="section-content mb-12 fade-in">
                                ...
                                <p class="mb-4">Welcome to Joyful. These Terms and Conditions govern your use of our website, products, and services. By accessing or using Joyful, you agree to be bound by these terms.</p>
                                <p>Joyful is committed to providing high-quality activewear and exceptional customer service. Please read these terms carefully before using our website or making a purchase.</p>
                            </section>

                            <!-- General Information -->
                            <section id="general" class="section-content mb-12 fade-in">
                                <h2 class="text-3xl font-bold mb-4">2. General Information</h2>
                                <p class="mb-4">Joyful is a brand of premium activewear designed for performance and style. We operate through our website and physical retail locations.</p>
                                <ul class="list-disc pl-6 space-y-2">
                                    <li>Website: www.Joyful.com</li>
                                    <li>Business Registration: Joyful Inc.</li>
                                    <li>Headquarters: 123 Fitness Street, Active City, AC 12345</li>
                                    <li>Customer Service: support@Joyful.com</li>
                                </ul>
                            </section>
                            ...
                            <section id="use-of-website" class="section-content mb-12 fade-in">
                                ...
                                <ul class="list-disc pl-6 space-y-2">
                                    ...
                                    <li>Respect the intellectual property rights of Joyful and others</li>
                                </ul>
                            ...
                            <section id="products" class="section-content mb-12 fade-in">
                                ...
                                <p class="mb-4">Joyful offers a range of activewear products including:</p>
                                <ul class="list-disc pl-6 space-y-2">
                            ...
                            <section id="intellectual" class="section-content mb-12 fade-in">
                                ...
                                <p class="mb-4">All content on this website, including but not limited to text, graphics, logos, images, and software, is the property of Joyful or its content suppliers and is protected by intellectual property laws.</p>
                                ...
                                <p class="mt-4">Joyful respects the intellectual property rights of others. If you believe your work has been copied in a way that constitutes copyright infringement, please contact us.</p>
                            </section>
                            ...
                            <section id="liability" class="section-content mb-12 fade-in">
                                ...
                                <p class="mb-4">Joyful shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising from your use of our website or products.</p>
                                ...
                                <p>Joyful makes no warranties or representations about the accuracy or completeness of the content on this website. The content is provided "as is" without any warranty of any kind.</p>
                            </section>
                            ...
                            <section id="changes" class="section-content mb-12 fade-in">
                                ...
                                <p class="mb-4">Joyful reserves the right to modify these Terms and Conditions at any time. Changes will be effective immediately upon posting on the website.</p>
                            ...
                            <section id="contact" class="section-content mb-12 fade-in">
                                ...
                                <div class="bg-gray-50 p-6 rounded-lg">
                                    <p class="mb-2"><strong>Email:</strong> support@Joyful.com</p>
                                    <p class="mb-2"><strong>Phone:</strong> (555) 123-4567</p>
                                    <p class="mb-2"><strong>Mail:</strong> Joyful Inc., 123 Fitness Street, Active City, AC 12345</p>
