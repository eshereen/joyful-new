    ...
    <section class=" realtive h-screen overflow-hidden  top-0 left-0 right-0">
        ...
        <div class="relative z-10 h-full flex items-center justify-center text-center text-white px-4">
            <div class="max-w-3xl">
                ...
                <button class="btn-primary bg-dark-brown text-white px-8 py-4 rounded-full text-lg font-medium">
                    Shop Now
                </button>
            </div>
        </div>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="collection-card relative overflow-hidden rounded-lg shadow-lg">
                    <img src="{{ $collection->getFirstMediaUrl('main_image') }}" alt="{{ $collection->name }}" class="w-full h-80 object-cover">
                    <div class="overlay-text absolute inset-0 flex flex-col justify-end p-6 text-white">
                        <h4 class="text-2xl font-bold mb-2">{{ $collection->name }}</h4>
	...
	<div class="my-10 md:my-24 container mx-auto flex flex-col md:flex-row shadow-sm overflow-hidden" x-data="{ testimonialActive: 2 }" x-cloak>
			...
			<div class="bg-white md:w-1/2">
				<div class="flex flex-col h-full relative">
					...
					<div class="flex my-4 justify-center items-center">
						...
						<button
							...
							class="text-center font-bold shadow-xs focus:outline-none focus:shadow-outline h-16 w-16 inline-block bg-dark-brown rounded-full mx-2"
						...
						<button
							...
							class="text-center font-bold shadow-xs focus:outline-none focus:shadow-outline h-12 w-12 inline-block bg-dark-brown rounded-full mx-2"
				...
				<div class="absolute right-0 bottom-0 mr-4 mb-4 hidden md:block">
					<button
						class="rounded-l-full border-r bg-white text-gray-500 focus:outline-none hover:text-dark-brown font-bold w-12 h-10"
						x-on:click="testimonialActive = testimonialActive === 1 ? 3 : testimonialActive - 1">
						&#8592;
					</button><button
						class="rounded-r-full bg-white text-gray-500 focus:outline-none hover:text-dark-brown font-bold w-12 h-10"
