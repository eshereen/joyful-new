...
<div class="bg-white" x-data="{
    ...
    <section class="overflow-hidden relative h-48 md:h-56">
        <div class="absolute inset-0 bg-fixed bg-center bg-cover" style="background-image: url('https://picsum.photos/seed/joyfulbar/1920/400.jpg');">
...
<!--Review-->
<section class="py-20 bg-white">
	<div class="container flex overflow-hidden flex-col mx-auto my-10 shadow-sm md:my-24 md:flex-row" x-data="{ testimonialActive: 2 }" x-cloak>
			...
			<div class="bg-white md:w-1/2">
				<div class="flex relative flex-col h-full">
					...
					<div class="absolute top-0 left-0 mt-3 ml-4 md:mt-5 md:ml-12">
						<svg xmlns="http://www.w3.org/2000/svg" class="w-12 h-12 text-gray-200 fill-current md:w-16 md:h-16" viewBox="0 0 24 24"><path d="M6.5 10c-.223 0-.437.034-.65.065.069-.232.14-.468.254-.68.114-.308.292-.575.469-.844.148-.291.409-.488.601-.737.201-.242.475-.403.692-.604.213-.21.492-.315.714-.463.232-.133.434-.28.65-.35.208-.086.39-.16.539-.222.302-.125.474-.197.474-.197L9.758 4.03c0 0-.218.052-.597.144C8.97 4.222 8.737 4.278 8.472 4.345c-.271.05-.56.187-.882.312C7.272 4.799 6.904 4.895 6.562 5.123c-.344.218-.741.4-1.091.692C5.132 6.116 4.723 6.377 4.421 6.76c-.33.358-.656.734-.909 1.162C3.219 8.33 3.02 8.778 2.81 9.221c-.19.443-.343.896-.468 1.336-.237.882-.343 1.72-.384 2.437-.034.718-.014 1.315.028 1.747.015.204.043.402.063.539.017.109.025.168.025.168l.026-.006C2.535 17.474 4.338 19 6.5 19c2.485 0 4.5-2.015 4.5-4.5S8.985 10 6.5 10zM17.5 10c-.223 0-.437.034-.65.065.069-.232.14-.468.254-.68.114-.308.292-.575.469-.844.148-.291.409-.488.601-.737.201-.242.475-.403.692-.604.213-.21.492-.315.714-.463.232-.133.434-.28.65-.35.208-.086.39-.16.539-.222.302-.125.474-.197.474-.197L20.758 4.03c0 0-.218.052-.597.144-.191.048-.424.104-.689.171-.271.05-.56.187-.882.312-.317.143-.686.238-1.028.467-.344.218-.741.4-1.091.692-.339.301-.748.562-1.05.944-.33.358-.656.734-.909 1.162C14.219 8.33 14.02 8.778 13.81 9.221c-.19.443-.343.896-.468 1.336-.237.882-.343 1.72-.384 2.437-.034.718-.014 1.315.028 1.747.015.204.043.402.063.539.017.109.025.168.025.168l.026-.006C13.535 17.474 15.338 19 17.5 19c2.485 0 4.5-2.015 4.5-4.5S19.985 10 17.5 10z"/></svg>
					</div>

					<div class="relative z-10 h-full">
						<div x-show.immediate="testimonialActive === 1">
							<p class="px-6 py-6 text-xl italic font-normal text-gray-600 serif md:px-16 md:py-10 md:text-2xl" x-show.transition="testimonialActive == 1">
								Leverage agile frameworks to provide a robust synopsis for high level overviews. Iterative approaches to corporate strategy foster collaborative thinking to further the overall value proposition. Organically grow the holistic world view of disruptive innovation via workplace diversity and empowerment.
							</p>
						</div>

						<div x-show.immediate="testimonialActive === 2">
							<p class="px-6 py-6 text-xl italic font-normal text-gray-600 serif md:px-16 md:py-10 md:text-2xl" x-show.transition="testimonialActive == 2">
								Bring to the table win-win survival strategies to ensure proactive domination. At the end of the day, going forward, a new normal that has evolved from generation X is on the runway heading towards a streamlined cloud solution. User generated content in real-time will have multiple touchpoints for offshoring.
							</p>
						</div>

						<div x-show.immediate="testimonialActive === 3">
							<p class="px-6 py-6 text-xl italic font-normal text-gray-600 serif md:px-16 md:py-10 md:text-2xl" x-show.transition="testimonialActive == 3">
					...
					<div class="flex justify-center items-center my-4">
						<button
							...
							:class="{'h-12 w-12 opacity-25 bg-dark-brown text-white': testimonialActive != 1, 'h-16 w-16 opacity-100 bg-dark-brown text-white': testimonialActive == 1 }"
						>JD</button>
						<button
							@click.prevent="testimonialActive = 2"
							class="inline-block mx-2 w-16 h-16 font-bold text-center rounded-full shadow-xs focus:outline-none focus:shadow-outline bg-dark-brown"
							:class="{'h-12 w-12 opacity-25 bg-dark-brown text-white': testimonialActive != 2, 'h-16 w-16 opacity-100 bg-dark-brown text-white': testimonialActive == 2 }"
						>WD</button>
						<button
							@click.prevent="testimonialActive = 3"
							class="inline-block mx-2 w-12 h-12 font-bold text-center rounded-full shadow-xs focus:outline-none focus:shadow-outline bg-dark-brown"
							:class="{'h-12 w-12 opacity-25 bg-dark-brown text-white': testimonialActive != 3, 'h-16 w-16 opacity-100 bg-dark-brown text-white': testimonialActive == 3 }"
						>JW</button>
					</div>
					...
					<div class="flex justify-center px-6 pt-2 pb-6 md:py-6">
						...
						<div class="text-center" x-show="testimonialActive == 3">
							...
							<small class="text-xs text-gray-500 truncate md:text-sm">Product Manager, Fake Corp.</small>
						</div>
					</div>
				</div>
			</div>
            	<div class="flex relative flex-col justify-center py-2 w-full md:py-24 md:w-1/2 item-center" style = "background-image:url('/imgs/review.jpeg');background-position:cover; background-repeate:no-repeate">

				<div class="absolute top-0 left-0 z-10 w-16 h-16 grid-indigo md:w-40 md:h-40 md:ml-20 md:mt-24"></div>

				<div class="relative z-20 px-6 py-2 mb-0 text-2xl font-semibold tracking-tight leading-tight text-white md:text-5xl md:py-6 md:px-1 md:w-64 md:mx-auto">
					<span class="md:block">What Our</span>
					<span class="md-block">Customers</span>
					<span class="block">Are Saying!</span>
				</div>

				<div class="hidden absolute right-0 bottom-0 mr-4 mb-4 md:block">
					<button
						class="w-12 h-10 font-bold text-gray-500 bg-white rounded-l-full border-r focus:outline-none hover:text-dark-brown"
						x-on:click="testimonialActive = testimonialActive === 1 ? 3 : testimonialActive - 1">
						&#8592;
					</button><button
						class="w-12 h-10 font-bold text-gray-500 bg-white rounded-r-full focus:outline-none hover:text-dark-brown"
