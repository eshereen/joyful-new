                        ...
                        <div class="p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                            ...
                            <button onclick="resetPaymentState()" class="mt-2 ml-2 px-3 py-1 bg-gray-600 text-white text-xs rounded hover:bg-gray-700">
                                Start Over
                                    ...
                                    <!-- Debug info -->
                @if(config('app.debug'))
                <div class="mt-4 p-3 bg-white rounded text-left text-xs">
        ...
        if (typeof paypal === 'undefined') {
            ...
            document.getElementById('paypal-button-container').innerHTML = `
                <div class="text-center p-4 bg-red-50 border border-red-200 rounded-lg">
                    ...
                    <p class="text-dark-brown text-sm mt-1">Please check your internet connection and refresh the page.</p>
                ...
                if (error.message && error.message.includes('Target window is closed')) {
                    ...
                    container.innerHTML = `
                        <div class="text-center p-4 bg-red-50 border border-red-200 rounded-lg">
                            ...
                            <p class="text-dark-brown text-sm mt-1">Payment capture failed: ${error.message || 'Unknown error'}</p>
                            <button onclick="location.reload()" class="mt-3 px-4 py-2 bg-red-600 text-white rounded hover:bg-red-700">
                                Try Again
                            </button>
                        </div>
        ...
        onError: function(err) {
            ...
            container.innerHTML = `
                <div class="text-center p-4 bg-red-50 border border-red-200 rounded-lg">
                    ...
                    <p class="text-dark-brown text-sm mt-1">An error occurred with PayPal. Please try again.</p>
                    <button onclick="location.reload()" class="mt-3 px-4 py-2 bg-red-600 text-white rounded hover:bg-red-700">
                        Try Again
                    </button>
                </div>
    ...
    try {
        ...
        container.innerHTML = `
            <div class="text-center p-4 bg-red-50 border border-red-200 rounded-lg">
                ...
                <p class="text-dark-brown text-sm mt-1">Error: ${error.message}</p>
                <button onclick="location.reload()" class="mt-3 px-4 py-2 bg-red-600 text-white rounded hover:bg-red-700">
                    Try Again
                </button>
            </div>
