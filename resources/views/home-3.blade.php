...
@section('content')
    ...
    <section class="relative h-screen overflow-hidden mt-16">
        ...
        <div class="video-container">
            ...
            <video autoplay muted loop playsinline preload="metadata" poster="poster.jpg" class="w-full h-full object-cover blur-sm hidden md:block">
                <source src="videos/Joyful.mp4" type="video/mp4">
            ...
            <video autoplay muted loop playsinline preload="metadata" poster="poster.jpg" class="w-full h-full object-cover blur-sm md:hidden">
                <source src="videos/Joyful-sm.mp4" type="video/mp4">
                Your browser does not support the video tag.
            </video>
        </div>
        ...
        <div class="relative z-10 h-full flex items-center justify-center hero-content">
            <div class="text-center text-white px-4">
                <h1 class="text-4xl md:text-6xl font-bold mb-4 slide-in">Joyful</h1>
    ...
    <section class="py-16 px-4">
       ...
       <!--     <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div class="relative overflow-hidden rounded-lg group animate-on-scroll">
                    <img src="https://picsum.photos/seed/Joyful1/400/500.jpg" alt="Tops" class="w-full h-full object-cover hover-zoom">
                ...
                <!-- Category 2
                <div class="relative overflow-hidden rounded-lg group animate-on-scroll">
                    <img src="https://picsum.photos/seed/Joyful2/400/500.jpg" alt="Bottoms" class="w-full h-full object-cover hover-zoom">
                    <div class="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                ...
                <!-- Category 3
                <div class="relative overflow-hidden rounded-lg group animate-on-scroll">
                    <img src="https://picsum.photos/seed/Joyful3/400/500.jpg" alt="Accessories" class="w-full h-full object-cover hover-zoom">
                    <div class="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                ...
                <!-- Category 4
                <div class="relative overflow-hidden rounded-lg group animate-on-scroll">
                    <img src="https://picsum.photos/seed/Joyful4/400/500.jpg" alt="Sale" class="w-full h-full object-cover hover-zoom">
                    <div class="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
    ...
    <section class="relative h-96 overflow-hidden animate-on-scroll">
        <img src="https://picsum.photos/seed/Joyful-banner1/1920/400.jpg" alt="Lifestyle Banner" class="w-full h-full object-cover">
    ...
    <section class="relative h-96 overflow-hidden animate-on-scroll">
        <img src="https://picsum.photos/seed/Joyful-banner2/1920/400.jpg" alt="Lifestyle Banner" class="w-full h-full object-cover">
        <div class="absolute inset-0 bg-black bg-opacity-30 flex items-center justify-center">
            <div class="text-center text-white px-4">
        ...
        <div class="container mx-auto">
            <div class="flex flex-col md:flex-row items-center justify-between">
                <div class="mb-8 md:mb-0 md:w-1/2 animate-on-scroll">
                    <h2 class="text-3xl font-bold mb-4">GET THE Joyful APP</h2>
