...
@section('content')
    ...
    <section class="relative h-screen overflow-hidden mt-16">
        <img src="https://images.unsplash.com/photo-1441986300917-64674bd600d8?q=80&w=1740&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="About Joyful" class="w-full h-full object-cover">
        ...
        <div class="container mx-auto">
            <div class="flex flex-col lg:flex-row items-center gap-12">
                <div class="lg:w-1/2 animate-on-scroll">
                    ...
                    <p class="mb-4 text-gray-700">Joyful is an Egyptian brand that mix between sports and lifestyle by offering sports clothing specially made to suit your physical fitness.
We have worked hard to provide the best we have in our clothing industry since 2016 in order to contribute to providing support to reach your goals.</p>
                    ...
                    <p class="text-gray-700">Today, Joyful is more than just a clothing brand – we're a community of fitness enthusiasts who believe in pushing boundaries and living life to the fullest.</p>
                </div>
                <div class="lg:w-1/2 animate-on-scroll">
                    <img src="https://picsum.photos/seed/Joyful-story/600/400.jpg" alt="Our Story" class="rounded-lg shadow-lg hover-zoom">
                </div>
            </div>
        </div>
    </section>
