...
<div class="bg-white text-black font-sans antialiased" x-data="{
    ...
    <section class="relative h-96 overflow-hidden mt-16">
        <img src="https://images.unsplash.com/photo-1441986300917-64674bd600d8?q=80&w=2940&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Joyful Locations" class="w-full h-full object-cover">
        <div class="relative z-10 h-full flex items-center justify-center">
            <div class="text-center text-white px-4">
                ...
                <p class="text-xl md:text-2xl max-w-2xl mx-auto slide-in-right">Find a Joyful store near you and experience premium activewear</p>
            </div>
        </div>
    </section>
    <!-- Locations Grid -->
    ...
    <div class="mb-4 my-20 mx-auto w-full">
        ...
        <div class="w-full h-screen">
            <iframe class="w-full h-full" src="https://www.google.com/maps/embed?pb=!1m12!1m8!1m3!1d221018.70662885447!2d31.260221000000005!3d30.053570999999998!3m2!1i1024!2i768!4f13.1!2m1!1sJoyful!5e0!3m2!1sen!2sus!4v1756546456816!5m2!1sen!2sus" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
    </div>
        </div>
