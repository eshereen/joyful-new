...
<div class="bg-white text-black font-sans antialiased" x-data="{
 ...
 <!-- Hero Section -->
    <section class="relative h-96 overflow-hidden mt-16">
        <img src="https://images.unsplash.com/photo-1653289755854-a41949e96282?q=80&w=2940&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Contact Joyful" class="w-full h-full object-cover object-top">
        ...
        <div class="container mx-auto">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="contact-card bg-white p-8 rounded-lg shadow-md text-center animate-on-scroll">
                    ...
                    <a href="mailto:support@Joyful.com" class="text-red-600 font-bold text-lg hover:underline">support@Joyful.com</a>
                </div>
            </div>
        </div>
    </section>
