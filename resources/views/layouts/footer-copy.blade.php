    ...
    <footer class="bg-gray-900 text-white py-12">
        <div class="container mx-auto px-6">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-10">
                ...
                <div>
                    <div class="flex items-center mb-6">
                        ...
                        <span class="ml-3 text-2xl font-bold text-white title-font">Joyful</span>
                    </div>
                    <p class="text-gray-400 mb-6">
                        Redefining modern elegance through sustainable fashion and impeccable craftsmanship.
                    </p>
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        ...
                        <li><a href="#" class="text-gray-400 hover:text-white transition">Dresses</a></li>
                        <li><a href="#" class="text-gray-400 hover:text-white transition">Tops</a></li>
                        <li><a href="#" class="text-gray-400 hover:text-white transition">Bottoms</a></li>
                ...
                <!-- Column 3 -->
                <div>
                    <h3 class="text-lg font-semibold mb-6">Information</h3>
                    <ul class="space-y-3">
            ...
            <div class="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
                <p class="text-gray-400 mb-4 md:mb-0">© 2025 Omera. All rights reserved.</p>
