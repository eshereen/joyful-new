                ...
                <section class="mb-16 animate-on-scroll">
                    ...
                    <div class="max-w-4xl mx-auto">
                        <div class="bg-white p-8 rounded-lg shadow-md mb-8">
                            ...
                            <p class="text-gray-700 mb-6">We want you to love your Joyful products. If for any reason you're not completely satisfied, you can return items within 14 days of delivery for a full refund.</p>
                                ...
                                <div class="space-y-4">
                                    <div class="flex items-start">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-gray-700">Log in to your Joyful account, go to "Order History," and select the item(s) you wish to return.</p>
                                        </div>
                                    </div>
                            ...
                            <div class="space-y-6 mb-8">
                                <div class="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-700">Log in to your Joyful account, go to "Order History," and select the item(s) you wish to exchange. Choose the new size, color, or style you'd like instead.</p>
                                    </div>
                                </div>
